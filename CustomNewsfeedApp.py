...
def fetch_news():
	try:
		vect = pickle.load(open(r'C:\Users\Dell\Desktop\ML Projects\Custom Newsfeed App\news_vect_pickle.p', 'rb'))
		model = pickle.load(open(r'C:\Users\Dell\Desktop\ML Projects\Custom Newsfeed App\news_model_pickle.p', 'rb'))
		...
		r = requests.post('https://maker.ifttt.com/trigger/news_event/with/key/d9HOfcg0V6T7P4eTpXw3WP', data=payload)
		'''
		# clean up worksheet
